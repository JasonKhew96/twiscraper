...
type UserByScreenNameFeatures struct {
	...
	ResponsiveWebTwitterBlueNewVerificationCopyIsEnabled bool `json:"responsive_web_twitter_blue_new_verification_copy_is_enabled"`
...
func NewUserByScreenNameFeatures() UserByScreenNameFeatures {
	return UserByScreenNameFeatures{
		...
		ResponsiveWebTwitterBlueNewVerificationCopyIsEnabled: true,
